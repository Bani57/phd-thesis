...
\begin{algorithm}[H]
    ...
    \STATE{$\mathbf{R}=\off{g_R\of{r}}_{r \in R}$}
    \STATE{$\mathbf{a}=g_V\of{a}, \mathbf{A}=\off{g_V\of{v}}_{v \in \mathcal{A}_{q}}$}
    \STATE{$\mathbf{q}=G_{q}\of{\mathbf{A};\of{\mathbf{R},g_P},g_I}$}
...
\STATE{$\mathbf{R}^{\of{C}}=\off{g^{\of{C}}_R\of{r}}_{r \in R}, \tilde{\mathbf{R}}=\off{g_R\of{r}}_{r \in R}$}
\STATE{$\mathbf{R} = \ang{ \mathrm{Softmax}\of{\mathbf{w}_R}, \off{\mathbf{R}^{\of{C}}, \tilde{\mathbf{R}}} }$}
\STATE{$q^{\of{C}} = \of{\off{c\of{v}}_{v \in \mathcal{A}_q},G_q}$}
\STATE{$\mathbf{a}^{\of{C}}=g^{\of{C}}_V\of{c\of{a}}, \mathbf{A}^{\of{C}}=\off{g^{\of{C}}_V\of{k}}_{k \in \mathcal{A}^{\of{C}}_{q}}$}
\STATE{$\mathbf{q}^{\of{C}}=G_{q}\of{\mathbf{A}^{\of{C}};\of{\mathbf{R}^{\of{C}},g_P^{\of{C}}},g_I^{\of{C}}}$}
\IF{$\forall v \in q, c\of{v}=c\of{a}$}
\STATE{$\tilde{\mathbf{a}}=g^{\of{c\of{a}}}_V\of{a}, \tilde{\mathbf{A}}=\off{g^{\of{c\of{a}}}_V\of{v}}_{v \in \mathcal{A}_{q}}$}
\ELSE
\STATE{$\tilde{\mathbf{a}}=g^{*}_V\of{z^*\of{a}}, \tilde{\mathbf{A}}=\off{g^{*}_V\of{z^*\of{v}}}_{v \in \mathcal{A}_{q}}$}
\ENDIF
\STATE{$\mathbf{a} = \ang{\mathrm{Softmax}\of{\mathbf{w}}, \off{\mathbf{W} \mathbf{x}_{a}, \mathbf{a}^{\of{C}}, \tilde{\mathbf{a}}}}, \mathbf{A}=\ang{ \mathrm{Softmax}\of{\mathbf{w}}, \off{\mathbf{W} \mathbf{x}_{v}}_{v \in \mathcal{A}_{q}}, \mathbf{A}^{\of{C}}, \tilde{\mathbf{A}} }$}
\STATE{$\mathbf{q}=G_{q}\of{\mathbf{A};\of{\mathbf{R},g_P},g_I}$}
...
\FOR{$i \gets 1$ to $N$}
\STATE{$q^{\of{C}}_i = \of{\off{c\of{v}}_{v \in \mathcal{A}_{q_i}},G_{q_i}}$}
\STATE{$s_C = \off{S_C\of{q^{\of{C}}_i, k}}_{k \in \mathcal{C}}$}
\STATE{$\rho^{\of{i}}_{C} = \mathrm{Rank}\of{c\of{a_i},s_C}$}
\STATE{$F_i=\sum_{1 \leq j < \rho^{\of{i}}_{C}}{\abs{C_{\mathrm{IndexRank}\of{j,s_C}}}}$}
\STATE{$s_V = \off{S_V\of{q_i, v}}_{v \in C_{c\of{a_i}}}$}
\STATE{$\tilde{\rho}^{\of{i}} = \mathrm{Rank}\of{a_i,s_V}$}
\STATE{$\rho^{\of{i}} = F_i + \tilde{\rho}^{\of{i}}$}
\ENDFOR
